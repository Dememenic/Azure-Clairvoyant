...
import net.clairvoyance.azure.Azure;
...
public class StatsCommand {
    ...
    public static void run(SlashCommandInteractionEvent event) {
        if (event.getName().equals(name)) {
            ...
            User manager = jda.getUserById(507947043046555669L);
            ...
            long uptime = currentTime - Azure.TIME;
            ...
            String version = Azure.getProperties().getProperty("version");

            EmbedBuilder embed = new EmbedBuilder();
            embed.setTitle("__**Azure Clairvoyant Stats:**__");
            embed.setDescription("Instance managed by: **" + manager.getAsTag() + "**");
            embed.setColor(Azure.COLOR);
