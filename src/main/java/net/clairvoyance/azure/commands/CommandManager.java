...
package net.clairvoyance.azure.commands;

import net.clairvoyance.azure.commands.global.*;
import net.clairvoyance.azure.commands.guild.DanmakuCommand;
...
public class CommandManager extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent event) {
        ...
        SkipCommand.run(event);
        NowPlayingCommand.run(event);
        QueueCommand.run(event);
        RepeatCommand.run(event);
        StopCommand.run(event);
    ...
    public void onReady(ReadyEvent event) {
        ...
        SkipCommand.register(commandData);
        QueueCommand.register(commandData);
        NowPlayingCommand.register(commandData);
        RepeatCommand.register(commandData);
        StopCommand.register(commandData);
